...
export namespace TouchscreenControls {
	...
	function configureTouchscreenControls(show12: boolean) {
		TouchScreenControls.createOrReplace(engine.RootEntity, {
			...
			hideCrosshair: false,
			touchInputs  : [
				{ inputAction: InputAction.IA_ACTION_3, hide: !show12 },
				{ inputAction: InputAction.IA_ACTION_4, hide: !show12 },
				...
				{ 
					...
					hide: false,
					icon: { tex: { $case: 'texture', texture: { src: 'assets/images/ui/tsc-booster.png' } } },
				},
				{ 
					inputAction: InputAction.IA_SECONDARY,
					hide: false,
					icon: { tex: { $case: 'texture', texture: { src: 'assets/images/ui/tsc-bird-strike.png' } } },
				},
			],
		})
	}
