---
name: npc-toolkit
description: Create NPCs capable of interacting with the player in a Decentraland SDK7 scene. NPCs can handle conversations, trigger actions, and handle dialog with embedded buttons.
---
...
1. Write a dialog script for your character, preferably on a separate file, making it of type `Dialog[]`.
...
1. Use that dialog when the NPC gets activated
